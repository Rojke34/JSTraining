...
function triConvert(num){
  ...
  if (numString.length === 8) {
    ...
    deca3 = units[parseInt(numString.charAt(2))] + hundred;
    deca3 += tens[parseInt(numString.charAt(3))];
    deca3 += units[parseInt(numString.charAt(4))] + thousand;
  ...
  if (numString.length === 9) {
    ...
    var deca4 = '';
    deca4 = units[parseInt(numString.charAt(3))] + hundred;
    deca4 += tens[parseInt(numString.charAt(4))];
    deca4 += units[parseInt(numString.charAt(5))];
    deca4 += thousand;
  ...
  if (numString.length === 10) {
    ...
    var deca5 = '';
    deca5 = units[parseInt(numString.charAt(4))] + hundred;
    deca5 += tens[parseInt(numString.charAt(5))];
    deca5 += units[parseInt(numString.charAt(6))];
    deca5 += thousand;
    ...
    return bill + mill4 + deca5 + output;
  }
  ...
  if (numString.length === 11) {
    ...
    var deca6 = '';
    deca6 = units[parseInt(numString.charAt(5))] + hundred;
    deca6 += tens[parseInt(numString.charAt(6))];
    deca6 += units[parseInt(numString.charAt(7))];
    deca6 += thousand;
    ...
    return bill1 + mill5 + deca6 + output;
  }
  ...
  if (numString.length === 12) {
    ...
    var deca7 = '';
    deca7 = units[parseInt(numString.charAt(6))] + hundred;
    deca7 += tens[parseInt(numString.charAt(7))];
    deca7 += units[parseInt(numString.charAt(8))];
    deca7 += thousand;
    ...
    return bill2 + mill6 + deca7 + output;
  }
